...
$line_icons_font_i = array(
      ...
      */
      $meta_boxes['events_metaboxs'] = array(
            'id'         => 'events_metaboxs',
            'title'      => __( 'MT Events Custom Options', 'modeltheme' ),
      ...
      */
      $meta_boxes['portfolios_metaboxs'] = array(
            ...
            'fields'     => array(
                  ...
                  array(
                        'name'       => __( 'Portfolio icon', 'modeltheme' ),
                        'desc'       => __( '', 'modeltheme' ),
			...
			array(
				...
				'default' => 'no',
                  ...
                  array(
                      ...
                      'type'    => 'radio',
                      'options' => array(
                          'header1'        => __( 'Header v1', 'modeltheme' ),
                          'header2'        => __( 'Header v2', 'modeltheme' ),
                          'header5'        => __( 'Header v3', 'modeltheme' ),
                          'header8'        => __( 'Header v4', 'modeltheme' ),
                          'header9'        => __( 'Header v5', 'modeltheme' ),
                          'header12'        => __( 'Header v6', 'modeltheme' ),
                          'header13'        => __( 'Header v7', 'modeltheme' ),
                          'header14'        => __( 'Header v8', 'modeltheme' ),
                  ...
                  */
                  ...
                  array(
                        ...
                        'desc'    => __( 'Set the background color of the Page Preloader(Default: #232331)', 'modeltheme' ),
                        'id'      => 'mt_page_preloader_bg_color',
                        'type'    => 'colorpicker',
                        'default' => '#232331'
                  ),
                  array(
                        'name'    => __( 'Blog Badge', 'modeltheme' ),
                        'desc'    => __( 'Set the Blog Badge text', 'modeltheme' ),
                        'id'      => 'mt_blog_badge',
                        'type'    => 'text',
                        'default' => ''
                  ),
                  array(
                        'name' => 'Blog Slider Icon',
                        'desc' => 'Upload Blog Slider Icon.',
                        'id'      => 'mt_slider_icon',
                        'type' => 'file'
                  ),
                  ...
                  */
                  ...
                  array(
                        'name'    => __( 'Footer Custom background color', 'modeltheme' ),
                        'desc'    => __( 'Set the background color of the footer(Default: #04ABE9)', 'modeltheme' ),
