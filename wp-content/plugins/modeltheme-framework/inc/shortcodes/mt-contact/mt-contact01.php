    ...
    $html = '';
        $html .= '<form method="POST" class="row wow '.$animation.'" id="contact01_form" novalidate="novalidate">';
          $html .= '<div class="content">';
            ...
            $html .= '<div class="vc_col-md-6 first_set_inputs">';
          ...
          $html .= '</div>';
              ...
              $html .= '<div class="vc_col-md-3 contact_button text-center">';
                  ...
                  <button name="contact_me" type="submit" class="vc_general vc_btn3 vc_btn3-size-md vc_btn3-shape-rounded vc_btn3-style-custom" style="background-color:'.$contact_button_color.'; color:#ffffff;">Contact us</button>';
