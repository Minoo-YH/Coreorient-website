...
function modeltheme_subscribe_form($params, $content) {
    ...
    $html .= '<div class="mc_embed_signup animateIn" data-animate="'.$animation.'">';
        $html .= '<h3 class="subscribe_title"><strong>'.$title_subscribe.'</strong></h3>';
        $html .= '<div class="email">';
            $html .= '<form class="subscribe" method="POST">';
                ...
                $html .= '<button class="btn-warning rippler rippler-default" name="submit_mailchimp" type="submit" style="background-color:'.$background_button_subscribe.';">'.$button_text.'</button>';
  ...
  vc_map( array(
     ...
     "params" => array(
        ...
        array(
           ...
           "holder" => "div",
           "class" => "",
           "heading" => esc_attr__("Text field title", 'modeltheme'),
           "param_name" => "title_subscribe",
           "value" => esc_attr__("Subscribe", 'modeltheme'),
           "description" => ""
        ),
        array(
           "group" => "Options",
