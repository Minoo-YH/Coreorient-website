    ...
    $pricing_table .= '<div class="row">';
      $pricing_table .= '<div class="pricing-section wow '.esc_attr($animation).'">';
          ...
          $pricing_table .= '<div class="pricing '.esc_attr($package_type).'">';
            $pricing_table .= '<div class="pricing__item '.esc_attr($package_recommended).'" style="background-color: '.esc_attr($package_background_style3).'">';
              $pricing_table .= '<h3 class="pricing__title" style="color: '.esc_attr($package_title_color).'">'.esc_attr($package_name).'</h3>';
              ...
              if ($package_style == 'pricing--norbu') {
                $pricing_table .= '<div class="pricing__price"><span class="pricing__currency">'.esc_attr($package_currency).'</span>'.esc_attr($package_price).'<span class="pricing__period">'.esc_attr($package_period).'</span></div>';
                  ...
                  $pricing_table .= '<div class="pricing__price" style="color: '.esc_attr($package_price_color).'">';
                      $pricing_table .= '<span class="pricing__currency">'.esc_attr($package_currency).'</span>'.esc_attr($package_price).'';
                      $pricing_table .= '<span class="pricing__period" style="color: '.esc_attr($package_title_color).'">'.esc_attr($package_period).'</span>';
                  $pricing_table .= '</div>';
              }
              ...
              $pricing_table .= '</ul>';
              $pricing_table .= '<a style="background-color: '.esc_attr($package_button_color_style3).'" class="pricing__action" href="'.esc_attr($button_url).'">'.esc_attr($button_text).'</a>';
            $pricing_table .= '</div>';
          $pricing_table .= '</div>';
      $pricing_table .= '</div>
    </div>
  ...
  vc_map( array(
     ...
     "params" => array(
        ...
        array(
          ...
          "type" => "colorpicker",
          "class" => "",
          "heading" => esc_attr__( "Price color", 'modeltheme' ),
          "param_name" => "package_price_color",
          "value" => "", //Default color
          "description" => esc_attr__( "Choose package price color", 'modeltheme' )
        ),
        array(
          "group" => "Styling",
          "dependency" => array(
          ...
          "param_name" => "package_title_color",
          "value" => "", //Default color
          "description" => esc_attr__( "Choose package title color", 'modeltheme' )
        ),
        array(
          "group" => "Styling",
          "dependency" => array(
