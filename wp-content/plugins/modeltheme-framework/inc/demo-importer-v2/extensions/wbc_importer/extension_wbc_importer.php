    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                '01 Main Home' => array(
                    'mt_eagle_content_slider.zip',
                    'mt_eagle_home_01.zip'
                ),
                '02 Home Parallax' => array(
                    'mt_eagle_content_slider.zip',
                    'mt_eagle_home_01.zip'
                ),
                '03 Air Transport' => array(
                    'alex-home7-slider.zip',
                    'our-team.zip'
                ),
                '04 Shipping Warehouse' => array(
                    'alex-home3-slider.zip',
                    'our-team.zip'
                ),
                '05 Rail Freight' => array(
                    'alex-home4-slider.zip'
                ),
                '06 Road Freight' => array(
                    'alex-home5-slider.zip'
                ),
                '07 Parallax 2' => array(
                    'mt_eagle_content_slider.zip',
                    'mt_eagle_home_01.zip'
                ),
                '08 Ocean Freight' => array(
                    'alex-home7-slider.zip'
                ),
                '09 Transporation And Cargo' => array(''),
            );
        ...
        *************************************************************************/
        ...
        $wbc_menu_array = array( 
            ...
            '02 Home Parallax',
            '03 Air Transport',
            '04 Shipping Warehouse',
            '05 Rail Freight',
            '06 Road Freight',
            '07 Parallax 2',
            '08 Ocean Freight',
            '09 Transporation And Cargo',
            );
        ...
        */
        ...
        $wbc_home_pages = array(
            '01 Main Home'   => '01 - Main Home',
            '02 Home Parallax'   => '02 – Home Parallax',
            '03 Air Transport'   => '03 – Air Transport',
            '04 Shipping Warehouse'   => '04 - Shipping Warehouse',
            '05 Rail Freight'   => '05 – Rail Freight',
            '06 Road Freight'   => '06 – Road Freight',
            '07 Parallax 2'   => '07 – Parallax',
            '08 Ocean Freight'   => '08 – Ocean Freight',
            '09 Transporation And Cargo'   => '09 - Transporation and Cargo',
