...
add_action( 'tgmpa_register', 'eaglewp_register_plugins' );
 ...
 */
function eaglewp_register_plugins() {
    /*
    ...
    $plugins = array(
        ...
        array(
            'name'                  => esc_html__('WPBakery Page Builder', 'eaglewp'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('Revolution Slider', 'eaglewp'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('Essential Grids', 'eaglewp'), // The plugin name
            ...
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
            'version'               => '3.0.13', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'          => '', // If set, overrides default API URL and points to an external URL
        ),
        array(
            'name'                  => esc_html__('Parallax Backgrounds for VC', 'eaglewp'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('ModelTheme Framework', 'eaglewp'), // The plugin name
            'slug'                  => 'modeltheme-framework', // The plugin slug (typically the folder name)
            'source'                => esc_url('http://modeltheme.com/TFPLUGINS/modeltheme-framework-eagle.zip'), // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name'                  => esc_html__('Cost Calculator', 'eaglewp'), // The plugin name
            'slug'                  => 'bt_cost_calculator', // The plugin slug (typically the folder name)
            'source'                => esc_url('http://modeltheme.com/TFPLUGINS/bt_cost_calculator.zip'), // The plugin source
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name'                  => esc_html__('Redux Framework', 'eaglewp'), // The plugin name
            'slug'                  => 'redux-framework', // The plugin slug (typically the folder name)
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ),
        array(
            'name'                  => esc_html__('Contact Form 7', 'eaglewp'), // The plugin name
